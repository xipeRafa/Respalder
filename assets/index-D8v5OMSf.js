 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function AM(t,e,n){let r=1,i=null,s=null,o=!1,a=0;function l(){return a===2}let c=!1;function h(...k){c||(c=!0,e.apply(null,k))}function f(k){i=setTimeout(()=>{i=null,t(w,l())},k)}function m(){s&&clearTimeout(s)}function w(k,...S){if(c){m();return}if(k){m(),h.call(null,k,...S);return}if(l()||o){m(),h.call(null,k,...S);return}r<64&&(r*=2);let T;a===1?(a=2,T=0):T=(r+Math.random())*1e3,f(T)}let A=!1;function b(k){A||(A=!0,m(),!c&&(i!==null?(k||(a=2),clearTimeout(i),f(0)):k||(a=1)))}return f(0),s=setTimeout(()=>{o=!0,b(!0)},n),b}function PM(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,m=`\r
--`+l+"--",w=Dn.getBlob(f,r,m);if(w===null)throw rP();const A={name:c.fullPath},b=Pi(s,t.host,t._protocol),k="POST",S=t.maxUploadRetryTime,v=new Pr(b,k,Dd(t,n),S);return v.urlParams=A,v.headers=o,v.body=w.uploadData(),v.errorHandler=ua(e),v}class Mh{constructor(e,n,r,i){this.current=e,this.total=n,this.finalized=!!r,this.metadata=i||null}}function K_(t,e){let n=null;try{n=t.getResponseHeader("X-Goog-Upload-Status")}catch{Gn(!1)}return Gn(!!n&&(e||["active"]).indexOf(n)!==-1),n}function aF(t,e,n,r,i){const s=e.bucketOnlyServerUrl(),o=mP(e,r,i),a={name:o.fullPath},l=Pi(s,t.host,t._protocol),c="POST",h={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},f=H_(o,n),m=t.maxUploadRetryTime;function w(b){K_(b);let k;try{k=b.getResponseHeader("X-Goog-Upload-URL")}catch{Gn(!1)}return Gn(Nd(k)),k}const A=new Pr(l,c,w,m);return A.urlParams=a,A.headers=h,A.body=f,A.errorHandler=ua(e),A}function lF(t,e,n,r){const i={"X-Goog-Upload-Command":"query"};function s(c){const h=K_(c,["active","final"]);let f=null;try{f=c.getResponseHeader("X-Goog-Upload-Size-Received")}catch{Gn(!1)}f||Gn(!1);const m=Number(f);return Gn(!isNaN(m)),new Mh(m,r.size(),h==="final")}const o="POST",a=t.maxUploadRetryTime,l=new Pr(n,o,s,a);return l.headers=i,l.errorHandler=ua(e),l}const tE=256*1024;function uF(t,e,n,r,i,s,o,a){const l=new Mh(0,0);if(o?(l.current=o.current,l.total=o.total):(l.current=0,l.total=r.size()),r.size()!==l.total)throw EM();const c=l.total-l.current;let h=c;i>0&&(h=Math.min(h,i));const f=l.current,m=f+h;let w="";h===0?w="finalize":c===h?w="upload, finalize":w="upload";const A={"X-Goog-Upload-Command":w,"X-Goog-Upload-Offset":`${l.current}`},b=r.slice(f,m);if(b===null)throw rP();function k(N,M){const F=K_(N,["active","final"]),R=l.current+h,_=r.size();let g;return F==="final"?g=Dd(e,s)(N,M):g=null,new Mh(R,_,F==="final",g)}const S="POST",v=e.maxUploadRetryTime,T=new Pr(n,S,k,v);return T.headers=A,T.body=b.uploadData(),T.progressCallback=a||null,T.errorHandler=ua(t),T}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const c4="storage-compat";function h4(t,{instanceIdentifier:e}){const n=t.getProvider("app-compat").getImmediate(),r=t.getProvider("storage").getImmediate({identifier:e});return new NC(n,r)}function d4(t){const e={TaskState:xt,TaskEvent:cF,StringFormat:cn,Storage:NC,Reference:fr};t.INTERNAL.registerComponent(new gn(c4,h4,"PUBLIC").setServiceProps(e).setMultipleInstances(!0)),t.registerVersion(l4,u4)}d4(bs);const vy=bs.initializeApp({apiKey:"AIzaSyBHgG4mwWSEUBLPS1p2XFtaC8GwPIv2xN8",authDomain:"arquidiocesishermosillo-776dd.firebaseapp.com",projectId:"arquidiocesishermosillo-776dd",storageBucket:"arquidiocesishermosillo-776dd.appspot.com",messagingSenderId:"767127814821",appId:"1:767127814821:web:6c159d62075bcd1271c34c"}),qm=uB(vy),DE=RL(vy),f4=DF(vy);function OE({postRegister:t,arrParroquiaState:e,setGetArr:n,getArr:r}){const[i,s]=U.useState({nombreBautismo:"",fechaBautismo:""}),{nombreBautismo:o,fechaBautismo:a}=i,l=({target:g})=>{const{name:E,value:C}=g;s({...i,[E]:C.replace(/\b\w/g,x=>x.toUpperCase())})},[c,h]=U.useState(""),f=g=>{h(g.target.files[0])},m=()=>{if(o.length<=0){alert("El Nombre esta Vacio");return}confirm("Quiere Guardar este Documento?")&&setTimeout(()=>{alert("Documento Guardado")},2e3),i.nombreBautismo=o.trim(),t(c,i),s({nombreBautismo:"",fechaBautismo:""})},[w,A]=U.useState(!1),[b,k]=U.useState(null),[S,v]=U.useState(""),T=({target:g})=>{M(null);const{name:E,value:C}=g;if(v(C.replace(/\b\w/g,x=>x.toUpperCase())),C.length>4){n(!r);let x=e.filter(P=>P[E].indexOf(C.replace(/\b\w/g,Oe=>Oe.toUpperCase()))>-1);x.length>=1?(k(x[0][E]),A(!1)):A(!0)}},[N,M]=U.useState(null),F=({target:g})=>{k(null);const{name:E,value:C}=g;e.filter(P=>P[E]==C).length>=1?(n(!r),M(C),A(!1)):A(!0)},[R,_]=U.useState(!0);return I.jsxs(I.Fragment,{children:[I.jsxs("div",{className:"ButtonsNuevoBuscar",children:[I.jsx("button",{onClick:()=>_(!0),children:"  Nuevo Bautismo"}),I.jsx("button",{onClick:()=>_(!1),children:" Buscar"})]}),R?I.jsxs("div",{className:"formInfoToSave",children:[I.jsx("p",{children:"Respaldar FE de Bautismo"}),I.jsx("input",{type:"text",name:"nombreBautismo",placeholder:"Nombre...",value:o,onChange:g=>l(g)}),I.jsx("input",{type:"date",name:"fechaBautismo",value:a,onChange:g=>l(g)}),I.jsx("input",{type:"file",name:"fileBautismo",onChange:g=>f(g)}),I.jsx("button",{className:"button-primary",onClick:m,children:"GUARDAR"})]}):I.jsxs("div",{className:"formInfoToFind",children:[I.jsxs("div",{children:[I.jsx("label",{htmlFor:"avatar1",children:"Buscar Bautismo con Nombre:"}),I.jsx("input",{type:"text",id:"avatar1",name:"nombreBautismo",value:S,onChange:g=>T(g),placeholder:"Nombre Completo..."})]}),I.jsxs("div",{children:[I.jsx("label",{htmlFor:"avatar2",children:"Buscar Bautismo con Fecha:"}),I.jsx("input",{type:"date",id:"avatar2",value:N,name:"fechaBautismo",onChange:g=>F(g)})]}),I.jsx("p",{className:b===null?"d-none":"cerrar",onClick:()=>k(null),children:"Cerrar Busquedas ✘"}),I.jsx("p",{className:N===null?"d-none":"cerrar",onClick:()=>M(null),children:"Cerrar Busquedas ✘"}),I.jsx("p",{className:w?"no-encontrado":"d-none",onClick:()=>A(!1),children:"No Encontrado ✘"}),b!==null?I.jsx("div",{className:"w-100",children:e.filter(g=>g.nombreBautismo==b).map((g,E)=>I.jsxs("div",{children:[I.jsx("hr",{}),I.jsxs("p",{children:[I.jsx("span",{children:"Nombre:"})," ",g.nombreBautismo]}),I.jsxs("p",{children:[I.jsx("span",{children:"Fecha:"})," ",g.fechaBautismo]}),I.jsxs("p",{children:[I.jsx("span",{children:"Documento:"})," ",g.fileName]}),I.jsx("a",{className:"doc",href:g.fileUrl,target:"_blanck",children:" Abrir Documento"}),I.jsx("hr",{})]},E))}):I.jsx("div",{className:"w-100",children:e.filter(g=>g.fechaBautismo==N).map((g,E)=>I.jsxs("div",{children:[I.jsx("hr",{}),I.jsxs("p",{className:"textMarc",children:[I.jsx("span",{children:"Nombre:"})," ",g.nombreBautismo]}),I.jsxs("p",{children:[I.jsx("span",{children:"Fecha:"})," ",g.fechaBautismo]}),I.jsxs("p",{children:[I.jsx("span",{children:"Documento:"})," ",g.fileName]}),I.jsx("a",{className:"doc",href:g.fileUrl,target:"_blanck",children:" Abrir Documento"}),I.jsx("hr",{})]},E))})]})]})}function p4({arrParroquiaState:t,setGetArr:e,getArr:n}){return I.jsx(I.Fragment,{children:I.jsx("p",{children:"Usuarios"})})}function m4({postRegister:t,arrParroquiaState:e,setGetArr:n,getArr:r}){const[i,s]=U.useState({nombreConfirmacion:"",fechaConfirmacion:""}),{nombreConfirmacion:o,fechaConfirmacion:a}=i,l=({target:g})=>{const{name:E,value:C}=g;s({...i,[E]:C.replace(/\b\w/g,x=>x.toUpperCase())})},[c,h]=U.useState(""),f=g=>{h(g.target.files[0])},m=()=>{if(o.length<=0){alert("El Nombre esta Vacio");return}confirm("Quiere Guardar este Documento?")&&setTimeout(()=>{alert("Documento Guardado")},2e3),i.nombreConfirmacion=o.trim(),t(c,i),s({nombreConfirmacion:"",fechaConfirmacion:""})},[w,A]=U.useState(!1),[b,k]=U.useState(null),[S,v]=U.useState(""),T=({target:g})=>{M(null);const{name:E,value:C}=g;if(v(C.replace(/\b\w/g,x=>x.toUpperCase())),C.length>4){n(!r);let x=e.filter(P=>P[E].indexOf(C.replace(/\b\w/g,Oe=>Oe.toUpperCase()))>-1);x.length>=1?(k(x[0][E]),A(!1)):A(!0)}},[N,M]=U.useState(null),F=({target:g})=>{k(null);const{name:E,value:C}=g;e.filter(P=>P[E]==C).length>=1?(n(!r),M(C),A(!1)):A(!0)},[R,_]=U.useState(!0);return I.jsxs(I.Fragment,{children:[I.jsxs("div",{className:"ButtonsNuevoBuscar",children:[I.jsx("button",{onClick:()=>_(!0),children:"Nueva Confirmación"}),I.jsx("button",{onClick:()=>_(!1),children:"Buscar"})]}),R?I.jsxs("div",{className:"formInfoToSave",children:[I.jsx("p",{children:"Respaldar Acta de Confirmacion"}),I.jsx("input",{type:"text",name:"nombreConfirmacion",placeholder:"Nombre...",value:o,onChange:g=>l(g)}),I.jsx("input",{type:"date",name:"fechaConfirmacion",value:a,onChange:g=>l(g)}),I.jsx("input",{type:"file",name:"fileConfirmacion",onChange:g=>f(g)}),I.jsx("button",{className:"button-primary",onClick:m,children:"GUARDAR"})]}):I.jsxs("div",{className:"formInfoToFind",children:[I.jsxs("div",{children:[I.jsx("label",{htmlFor:"avatar1",children:"Buscar Confirmación con Nombre:"}),I.jsx("input",{type:"text",id:"avatar1",name:"nombreConfirmacion",value:S,onChange:g=>T(g),placeholder:"Nombre Completo..."})]}),I.jsxs("div",{children:[I.jsx("label",{htmlFor:"avatar2",children:"Buscar Confirmación con Fecha:"}),I.jsx("input",{type:"date",id:"avatar2",value:N,name:"fechaConfirmacion",onChange:g=>F(g)})]}),I.jsx("p",{className:b===null?"d-none":"cerrar",onClick:()=>k(null),children:"Cerrar Busquedas ✘"}),I.jsx("p",{className:N===null?"d-none":"cerrar",onClick:()=>M(null),children:"Cerrar Busquedas ✘"}),I.jsx("p",{className:w?"no-encontrado":"d-none",onClick:()=>A(!1),children:"No Encontrado ✘"}),b!==null?I.jsx("div",{className:"w-100",children:e.filter(g=>g.nombreConfirmacion==b).map((g,E)=>I.jsxs("div",{children:[I.jsx("hr",{}),I.jsxs("p",{children:[I.jsx("span",{children:"Nombre:"})," ",g.nombreConfirmacion]}),I.jsxs("p",{children:[I.jsx("span",{children:"Fecha:"})," ",g.fechaConfirmacion]}),I.jsxs("p",{children:[I.jsx("span",{children:"Documento:"})," ",g.fileName]}),I.jsx("a",{className:"doc",href:g.fileUrl,target:"_blanck",children:" Abrir Documento"}),I.jsx("hr",{})]},E))}):I.jsx("div",{className:"w-100",children:e.filter(g=>g.fechaConfirmacion==N).map((g,E)=>I.jsxs("div",{children:[I.jsx("hr",{}),I.jsxs("p",{className:"textMarc",children:[I.jsx("span",{children:"Nombre:"})," ",g.nombreConfirmacion]}),I.jsxs("p",{children:[I.jsx("span",{children:"Fecha:"})," ",g.fechaConfirmacion]}),I.jsxs("p",{children:[I.jsx("span",{children:"Documento:"})," ",g.fileName]}),I.jsx("a",{className:"doc",href:g.fileUrl,target:"_blanck",children:" Abrir Documento"}),I.jsx("hr",{})]},E))})]})]})}function g4({postRegister:t,arrParroquiaState:e,setGetArr:n,getArr:r}){const[i,s]=U.useState({nombreComunion:"",fechaComunion:""}),{nombreComunion:o,fechaComunion:a}=i,l=({target:g})=>{const{name:E,value:C}=g;s({...i,[E]:C.replace(/\b\w/g,x=>x.toUpperCase())})},[c,h]=U.useState(""),f=g=>{h(g.target.files[0])},m=()=>{if(o.length<=0){alert("El Nombre esta Vacio");return}confirm("Quiere Guardar este Documento?")&&setTimeout(()=>{alert("Documento Guardado")},2e3),i.nombreComunion=o.trim(),t(c,i),s({nombreComunion:"",fechaComunion:""})},[w,A]=U.useState(!1),[b,k]=U.useState(null),[S,v]=U.useState(""),T=({target:g})=>{M(null);const{name:E,value:C}=g;if(v(C.replace(/\b\w/g,x=>x.toUpperCase())),C.length>4){n(!r);let x=e.filter(P=>P[E].indexOf(C.replace(/\b\w/g,Oe=>Oe.toUpperCase()))>-1);x.length>=1?(k(x[0][E]),A(!1)):A(!0)}},[N,M]=U.useState(null),F=({target:g})=>{k(null);const{name:E,value:C}=g;e.filter(P=>P[E]==C).length>=1?(n(!r),M(C),A(!1)):A(!0)},[R,_]=U.useState(!0);return I.jsxs(I.Fragment,{children:[I.jsxs("div",{className:"ButtonsNuevoBuscar",children:[I.jsx("button",{onClick:()=>_(!0),children:"Nueva Comunion"}),I.jsx("button",{onClick:()=>_(!1),children:"Buscar"})]}),R?I.jsxs("div",{className:"formInfoToSave",children:[I.jsx("p",{children:"Respaldar Acta de Comunion"}),I.jsx("input",{type:"text",name:"nombreComunion",placeholder:"Nombre...",value:o,onChange:g=>l(g)}),I.jsx("input",{type:"date",name:"fechaComunion",value:a,onChange:g=>l(g)}),I.jsx("input",{type:"file",name:"fileComunion",onChange:g=>f(g)}),I.jsx("button",{className:"button-primary",onClick:m,children:"GUARDAR"})]}):I.jsxs("div",{className:"formInfoToFind",children:[I.jsxs("div",{children:[I.jsx("label",{htmlFor:"avatar1",children:"Buscar Comunion con Nombre:"}),I.jsx("input",{type:"text",id:"avatar1",name:"nombreComunion",value:S,onChange:g=>T(g),placeholder:"Nombre Completo..."})]}),I.jsxs("div",{children:[I.jsx("label",{htmlFor:"avatar2",children:"Buscar Comunion con Fecha:"}),I.jsx("input",{type:"date",id:"avatar2",value:N,name:"fechaComunion",onChange:g=>F(g)})]}),I.jsx("p",{className:b===null?"d-none":"cerrar",onClick:()=>k(null),children:"Cerrar Busquedas ✘"}),I.jsx("p",{className:N===null?"d-none":"cerrar",onClick:()=>M(null),children:"Cerrar Busquedas ✘"}),I.jsx("p",{className:w?"no-encontrado":"d-none",onClick:()=>A(!1),children:"No Encontrado ✘"}),b!==null?I.jsx("div",{className:"w-100",children:e.filter(g=>g.nombreComunion==b).map((g,E)=>I.jsxs("div",{children:[I.jsx("hr",{}),I.jsxs("p",{children:[I.jsx("span",{children:"Nombre:"})," ",g.nombreComunion]}),I.jsxs("p",{children:[I.jsx("span",{children:"Fecha:"})," ",g.fechaComunion]}),I.jsxs("p",{children:[I.jsx("span",{children:"Documento:"})," ",g.fileName]}),I.jsx("a",{className:"doc",href:g.fileUrl,target:"_blanck",children:" Abrir Documento"}),I.jsx("hr",{})]},E))}):I.jsx("div",{className:"w-100",children:e.filter(g=>g.fechaComunion==N).map((g,E)=>I.jsxs("div",{children:[I.jsx("hr",{}),I.jsxs("p",{className:"textMarc",children:[I.jsx("span",{children:"Nombre:"})," ",g.nombreComunion]}),I.jsxs("p",{children:[I.jsx("span",{children:"Fecha:"})," ",g.fechaComunion]}),I.jsxs("p",{children:[I.jsx("span",{children:"Documento:"})," ",g.fileName]}),I.jsx("a",{className:"doc",href:g.fileUrl,target:"_blanck",children:" Abrir Documento"}),I.jsx("hr",{})]},E))})]})]})}function _4({postRegister:t,arrParroquiaState:e,setGetArr:n,getArr:r}){const[i,s]=U.useState({nombreMatrimonio:"",fechaMatrimonio:""}),{nombreMatrimonio:o,fechaMatrimonio:a}=i,l=({target:g})=>{const{name:E,value:C}=g;s({...i,[E]:C.replace(/\b\w/g,x=>x.toUpperCase())})},[c,h]=U.useState(""),f=g=>{h(g.target.files[0])},m=()=>{if(o.length<=0){alert("El Nombre esta Vacio");return}confirm("Quiere Guardar este Documento?")&&setTimeout(()=>{alert("Documento Guardado")},2e3),i.nombreMatrimonio=o.trim(),t(c,i),s({nombreMatrimonio:"",fechaMatrimonio:""})},[w,A]=U.useState(!1),[b,k]=U.useState(null),[S,v]=U.useState(""),T=({target:g})=>{M(null);const{name:E,value:C}=g;if(v(C.replace(/\b\w/g,x=>x.toUpperCase())),C.length>4){n(!r);let x=e.filter(P=>P[E].indexOf(C.replace(/\b\w/g,Oe=>Oe.toUpperCase()))>-1);x.length>=1?(k(x[0][E]),A(!1)):A(!0)}},[N,M]=U.useState(null),F=({target:g})=>{k(null);const{name:E,value:C}=g;e.filter(P=>P[E]==C).length>=1?(n(!r),M(C),A(!1)):A(!0)},[R,_]=U.useState(!0);return I.jsxs(I.Fragment,{children:[I.jsxs("div",{className:"ButtonsNuevoBuscar",children:[I.jsx("button",{onClick:()=>_(!0),children:"Nuevo Matrimonio"}),I.jsx("button",{onClick:()=>_(!1),children:"Buscar"})]}),R?I.jsxs("div",{className:"formInfoToSave",children:[I.jsx("p",{children:"Respaldar Acta de Matrimonio"}),I.jsx("input",{type:"text",name:"nombreMatrimonio",placeholder:"Nombre de Esposo...",value:o,onChange:g=>l(g)}),I.jsx("input",{type:"date",name:"fechaMatrimonio",value:a,onChange:g=>l(g)}),I.jsx("input",{type:"file",name:"fileMatrimonio",onChange:g=>f(g)}),I.jsx("button",{className:"button-primary",onClick:m,children:"GUARDAR"})]}):I.jsxs("div",{className:"formInfoToFind",children:[I.jsxs("div",{children:[I.jsx("label",{htmlFor:"avatar1",children:"Buscar Matrimonio con Nombre:"}),I.jsx("input",{type:"text",id:"avatar1",name:"nombreMatrimonio",value:S,onChange:g=>T(g),placeholder:"Nombre Completo de Esposo..."})]}),I.jsxs("div",{children:[I.jsx("label",{htmlFor:"avatar2",children:"Buscar Matrimonio con Fecha:"}),I.jsx("input",{type:"date",id:"avatar2",value:N,name:"fechaMatrimonio",onChange:g=>F(g)})]}),I.jsx("p",{className:b===null?"d-none":"cerrar",onClick:()=>k(null),children:"Cerrar Busquedas ✘"}),I.jsx("p",{className:N===null?"d-none":"cerrar",onClick:()=>M(null),children:"Cerrar Busquedas ✘"}),I.jsx("p",{className:w?"no-encontrado":"d-none",onClick:()=>A(!1),children:"No Encontrado ✘"}),b!==null?I.jsx("div",{className:"w-100",children:e.filter(g=>g.nombreMatrimonio==b).map((g,E)=>I.jsxs("div",{children:[I.jsx("hr",{}),I.jsxs("p",{children:[I.jsx("span",{children:"Nombre:"})," ",g.nombreMatrimonio]}),I.jsxs("p",{children:[I.jsx("span",{children:"Fecha:"})," ",g.fechaMatrimonio]}),I.jsxs("p",{children:[I.jsx("span",{children:"Documento:"})," ",g.fileName]}),I.jsx("a",{className:"doc",href:g.fileUrl,target:"_blanck",children:" Abrir Documento"}),I.jsx("hr",{})]},E))}):I.jsx("div",{className:"w-100",children:e.filter(g=>g.fechaMatrimonio==N).map((g,E)=>I.jsxs("div",{children:[I.jsx("hr",{}),I.jsxs("p",{className:"textMarc",children:[I.jsx("span",{children:"Nombre:"})," ",g.nombreMatrimonio]}),I.jsxs("p",{children:[I.jsx("span",{children:"Fecha:"})," ",g.fechaMatrimonio]}),I.jsxs("p",{children:[I.jsx("span",{children:"Documento:"})," ",g.fileName]}),I.jsx("a",{className:"doc",href:g.fileUrl,target:"_blanck",children:" Abrir Documento"}),I.jsx("hr",{})]},E))})]})]})}function y4({postRegister:t,arrParroquiaState:e,setGetArr:n,getArr:r}){const[i,s]=U.useState({nombreDefuncion:"",fechaDefuncion:""}),{nombreDefuncion:o,fechaDefuncion:a}=i,l=({target:g})=>{const{name:E,value:C}=g;s({...i,[E]:C.replace(/\b\w/g,x=>x.toUpperCase())})},[c,h]=U.useState(""),f=g=>{h(g.target.files[0])},m=()=>{if(o.length<=0){alert("El Nombre esta Vacio");return}confirm("Quiere Guardar este Documento?")&&setTimeout(()=>{alert("Documento Guardado")},2e3),i.nombreDefuncion=o.trim(),t(c,i),s({nombreDefuncion:"",fechaDefuncion:""})},[w,A]=U.useState(!1),[b,k]=U.useState(null),[S,v]=U.useState(""),T=({target:g})=>{M(null);const{name:E,value:C}=g;if(v(C.replace(/\b\w/g,x=>x.toUpperCase())),C.length>4){n(!r);let x=e.filter(P=>P[E].indexOf(C.replace(/\b\w/g,Oe=>Oe.toUpperCase()))>-1);x.length>=1?(k(x[0][E]),A(!1)):A(!0)}},[N,M]=U.useState(null),F=({target:g})=>{k(null);const{name:E,value:C}=g;e.filter(P=>P[E]==C).length>=1?(n(!r),M(C),A(!1)):A(!0)},[R,_]=U.useState(!0);return I.jsxs(I.Fragment,{children:[I.jsxs("div",{className:"ButtonsNuevoBuscar",children:[I.jsx("button",{onClick:()=>_(!0),children:"Nueva Defunción"}),I.jsx("button",{onClick:()=>_(!1),children:"Buscar"})]}),R?I.jsxs("div",{className:"formInfoToSave",children:[I.jsx("p",{children:"Respaldar Acta de Defunción"}),I.jsx("input",{type:"text",name:"nombreDefuncion",placeholder:"Nombre de Esposo...",value:o,onChange:g=>l(g)}),I.jsx("input",{type:"date",name:"fechaDefuncion",value:a,onChange:g=>l(g)}),I.jsx("input",{type:"file",name:"fileDefuncion",onChange:g=>f(g)}),I.jsx("button",{className:"button-primary",onClick:m,children:"GUARDAR"})]}):I.jsxs("div",{className:"formInfoToFind",children:[I.jsxs("div",{children:[I.jsx("label",{htmlFor:"avatar1",children:"Buscar Defunción con Nombre:"}),I.jsx("input",{type:"text",id:"avatar1",name:"nombreDefuncion",value:S,onChange:g=>T(g),placeholder:"Nombre Completo de Esposo..."})]}),I.jsxs("div",{children:[I.jsx("label",{htmlFor:"avatar2",children:"Buscar Defunción con Fecha:"}),I.jsx("input",{type:"date",id:"avatar2",value:N,name:"fechaDefuncion",onChange:g=>F(g)})]}),I.jsx("p",{className:b===null?"d-none":"cerrar",onClick:()=>k(null),children:"Cerrar Busquedas ✘"}),I.jsx("p",{className:N===null?"d-none":"cerrar",onClick:()=>M(null),children:"Cerrar Busquedas ✘"}),I.jsx("p",{className:w?"no-encontrado":"d-none",onClick:()=>A(!1),children:"No Encontrado ✘"}),b!==null?I.jsx("div",{className:"w-100",children:e.filter(g=>g.nombreDefuncion==b).map((g,E)=>I.jsxs("div",{children:[I.jsx("hr",{}),I.jsxs("p",{children:[I.jsx("span",{children:"Nombre:"})," ",g.nombreDefuncion]}),I.jsxs("p",{children:[I.jsx("span",{children:"Fecha:"})," ",g.fechaDefuncion]}),I.jsxs("p",{children:[I.jsx("span",{children:"Documento:"})," ",g.fileName]}),I.jsx("a",{className:"doc",href:g.fileUrl,target:"_blanck",children:" Abrir Documento"}),I.jsx("hr",{})]},E))}):I.jsx("div",{className:"w-100",children:e.filter(g=>g.fechaDefuncion==N).map((g,E)=>I.jsxs("div",{children:[I.jsx("hr",{}),I.jsxs("p",{className:"textMarc",children:[I.jsx("span",{children:"Nombre:"})," ",g.nombreDefuncion]}),I.jsxs("p",{children:[I.jsx("span",{children:"Fecha:"})," ",g.fechaDefuncion]}),I.jsxs("p",{children:[I.jsx("span",{children:"Documento:"})," ",g.fileName]}),I.jsx("a",{className:"doc",href:g.fileUrl,target:"_blanck",children:" Abrir Documento"}),I.jsx("hr",{})]},E))})]})]})}const v4="https://xipeRafa.github.io/Respalder/assets/abc-EqxUIFmM.jpeg",w4="_loginContainer_2tlrl_1",I4="_borderB_2tlrl_71",E4="_borderBgray_2tlrl_79",T4="_inputBG_2tlrl_89",S4="_colorRed_2tlrl_118",R4="_hello_2tlrl_122",bn={loginContainer:w4,borderB:I4,borderBgray:E4,inputBG:T4,colorRed:S4,hello:R4},A4=()=>{const t=async(r,i,s)=>{try{await ZP(r,i,s),e(r,i,s)}catch(o){console.error("code.error",o.code);const a={"auth/email-already-in-use":()=>alert("El Correo ya esta en Uso"),"auth/operation-not-allowed":()=>alert("Operacion No Permitida."),"auth/weak-password":()=>alert("La Contraseña es muy débil."),"auth/invalid-email":()=>alert("El Correo No es Valido")};(c=>{a[c]()})(o.code)}},e=(r,i,s)=>{eC(r,i,s).then(o=>{const a=o.user;localStorage.setItem("userEmailLS",a.email),location.reload()}).catch(o=>{console.log(o.code),console.log(o.message),o.code=="auth/invalid-credential"&&alert("Contraseña o Correo son Incorrrectos")})};return[t,e,()=>{AU(qm),localStorage.removeItem("userEmailLS"),location.reload()}]};function P4(){const[t,e]=U.useState(!0),[n,r,i]=A4(),[s,o]=U.useState({name:"",email:"",password:"",password2:""}),{name:a,email:l,password:c,password2:h}=s,f=k=>{w("");const{name:S,value:v}=k.target;o({...s,[S]:v})},[m,w]=U.useState("");console.log(m);const A=()=>{if(w(""),c.length<1)return w("Nombre No Escrito");if(c!==h)return w("Passwords No son Iguales");if(c.length<6)return w("La Clave es muy Corta Use 6 Caracteres Minimo");n(qm,l,c)},b=()=>{if(w(""),c.length<1)return w("Correo no Escrito");if(c.length<6)return w("Claves es muy corta Use 6 caracteres Minimo");r(qm,l,c)};return I.jsx(I.Fragment,{children:localStorage.getItem("userEmailLS")===null?I.jsxs("div",{className:bn.loginContainer,children:[I.jsxs("div",{children:[" ",I.jsx("img",{src:v4})," "]}),I.jsxs("div",{children:[I.jsxs("div",{children:[I.jsx("div",{className:t?bn.borderB:bn.borderBgray,onClick:()=>{e(!0),w("")},children:"REGISTRARSE"}),I.jsx("div",{className:t?bn.borderBgray:bn.borderB,onClick:()=>{e(!1),w("")},children:"ENTRAR"})]}),I.jsx("div",{children:t?I.jsxs("div",{className:bn.inputBG,children:[I.jsx("div",{children:I.jsx("input",{type:"text",name:"name",onChange:k=>f(k),placeholder:"Nombre"})}),I.jsx("div",{children:I.jsx("input",{type:"email",name:"email",onChange:k=>f(k),placeholder:"Correo"})}),I.jsx("div",{children:I.jsx("input",{type:"password",name:"password",onChange:k=>f(k),placeholder:"Password"})}),I.jsx("div",{children:I.jsx("input",{type:"password",name:"password2",onChange:k=>f(k),placeholder:"Confirmar Password"})}),I.jsx("div",{children:I.jsx("button",{onClick:()=>A(),children:"ENVIAR"})}),I.jsx("span",{className:bn.colorRed,children:m})]}):I.jsxs("div",{className:bn.inputBG,children:[I.jsx("div",{children:I.jsx("input",{type:"email",name:"email",onChange:k=>f(k),placeholder:"Correo"})}),I.jsx("div",{children:I.jsx("input",{type:"password",name:"password",onChange:k=>f(k),placeholder:"Password"})}),I.jsx("div",{children:I.jsx("button",{onClick:()=>b(),children:"ENTRAR"})}),I.jsx("span",{className:bn.colorRed,children:m})]})})]})]}):I.jsxs("div",{className:bn.hello,children:[I.jsx("span",{children:localStorage.userEmailLS}),I.jsx("button",{onClick:()=>i(),children:"SALIR"})]})})}function C4(){const[t,e]=U.useState(!0),n=window.innerWidth,r=()=>{n<999&&e(!0)};return I.jsx("div",{className:"navBar3",children:localStorage.getItem("userEmailLS")!==null&&I.jsxs(I.Fragment,{children:[I.jsxs("div",{onClick:()=>e(!t),className:"hamburger",children:[I.jsxs("div",{className:"menu-bar",children:[I.jsx("div",{className:"uno"}),I.jsx("div",{className:"dos"}),I.jsx("div",{className:"tres"})]}),I.jsx("p",{className:"menuIcons",children:t?I.jsx("b",{className:"menuIcon",children:"MENU"}):I.jsx("b",{className:"menuIconX",children:"✘"})})]}),I.jsxs("div",{className:t?"menu3 ":"menu3 display",onClick:r,children:[I.jsx(Oi,{to:"/Respalder",children:"Mi Parroquia"}),I.jsx(Oi,{to:"/Respalder/bautismos",children:"Bautismos"}),I.jsx(Oi,{to:"/Respalder/comuniones",children:" Comuniones"}),I.jsx(Oi,{to:"/Respalder/confirmaciones",children:" Confirmaciones "}),I.jsx(Oi,{to:"/Respalder/matrimonios",children:" Matrimonios"}),I.jsx(Oi,{to:"/Respalder/defunciones",children:" Defunciones"}),I.jsx(Oi,{to:"/Respalder/usuarios",children:" Usuarios"})]}),"   "]})})}function k4(){const t=Xo();let e;e=t.pathname.split("/")[2],console.log(e);const[n,r]=U.useState([]),[i,s]=U.useState(!1);U.useEffect(()=>{const a=Oh(DE,e||"bautismos");YA(a).then(l=>{r(l.docs.map(c=>({...c.data(),id:c.id})))}).catch(l=>{console.error(l)})},[i]);const o=(a,l)=>{const c=Oh(DE,e||"bautismos"),h=Nm(f4,`${e}-Files/${Date.now()}/${a==null?void 0:a.name}`);RF(h,a).then(()=>{TP(h).then(f=>{l.fileName=a.name,l.fileUrl=f,JA(c,l)})}).catch(f=>{console.log("postRegister Error, App,jsx, linea 82"),console.log(f)})};return I.jsxs("div",{className:localStorage.getItem("userEmailLS")!==null?"containerApp":"containerApp2",children:[I.jsx(C4,{}),I.jsx("h3",{className:"registroParroquial-h3",children:"RESPALDER PARROQUIAL"}),I.jsxs(Px,{children:[I.jsx(nr,{path:"/Respalder",element:I.jsx(P4,{})}),I.jsx(nr,{path:"/Respalder/confirmaciones",element:I.jsx(m4,{postRegister:o,arrParroquiaState:n,setGetArr:s,getArr:i})}),I.jsx(nr,{path:"/Respalder/comuniones",element:I.jsx(g4,{postRegister:o,arrParroquiaState:n,setGetArr:s,getArr:i})}),I.jsx(nr,{path:"/Respalder/matrimonios",element:I.jsx(_4,{postRegister:o,arrParroquiaState:n,setGetArr:s,getArr:i})}),I.jsx(nr,{path:"/Respalder/defunciones",element:I.jsx(y4,{postRegister:o,arrParroquiaState:n,setGetArr:s,getArr:i})}),I.jsx(nr,{path:"/Respalder/bautismos",element:I.jsx(OE,{postRegister:o,arrParroquiaState:n,setGetArr:s,getArr:i})}),I.jsx(nr,{path:"/Respalder/usuarios",element:I.jsx(p4,{postRegister:o,arrParroquiaState:n,setGetArr:s,getArr:i})}),I.jsx(nr,{path:"*",element:I.jsx(OE,{postRegister:o,arrParroquiaState:n,setGetArr:s,getArr:i})})]})]})}lp.createRoot(document.getElementById("root")).render(I.jsx(Vx,{children:I.jsx(k4,{})}));

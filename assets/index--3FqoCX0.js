 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(H,ee){var K=H.length;H.push(ee);e:for(;0<K;){var te=K-1>>>1,re=H[te];if(0<i(re,ee))H[te]=ee,H[K]=re,K=te;else break e}}function n(H){return H.length===0?null:H[0]}function r(H){if(H.length===0)return null;var ee=H[0],K=H.pop();if(K!==ee){H[0]=K;e:for(var te=0,re=H.length,se=re>>>1;te<se;){var vn=2*(te+1)-1,Xn=H[vn],Zn=vn+1,er=H[Zn];if(0>i(Xn,K))Zn<re&&0>i(er,Xn)?(H[te]=er,H[Zn]=K,te=Zn):(H[te]=Xn,H[vn]=K,te=vn);else if(Zn<re&&0>i(er,K))H[te]=er,H[Zn]=K,te=Zn;else break e}}return ee}function i(H,ee){var K=H.sortIndex-ee.sortIndex;return K!==0?K:H.id-ee.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],h=1,f=null,m=3,g=!1,T=!1,S=!1,k=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(H){for(var ee=n(c);ee!==null;){if(ee.callback===null)r(c);else if(ee.startTime<=H)r(c),ee.sortIndex=ee.expirationTime,e(l,ee);else break;ee=n(c)}}function C(H){if(S=!1,y(H),!T)if(n(l)!==null)T=!0,Ci(V);else{var ee=n(c);ee!==null&&yn(C,ee.startTime-H)}}function V(H,ee){T=!1,S&&(S=!1,I(w),w=-1),g=!0;var K=m;try{for(y(ee),f=n(l);f!==null&&(!(f.expirationTime>ee)||H&&!b());){var te=f.callback;if(typeof te=="function"){f.callback=null,m=f.priorityLevel;var re=te(f.expirationTime<=ee);ee=t.unstable_now(),typeof re=="function"?f.callback=re:f===n(l)&&r(l),y(ee)}else r(l);f=n(l)}if(f!==null)var se=!0;else{var vn=n(c);vn!==null&&yn(C,vn.startTime-ee),se=!1}return se}finally{f=null,m=K,g=!1}}var M=!1,E=null,w=-1,R=5,A=-1;function b(){return!(t.unstable_now()-A<R)}function x(){if(E!==null){var H=t.unstable_now();A=H;var ee=!0;try{ee=E(!0,H)}finally{ee?P():(M=!1,E=null)}}else M=!1}var P;if(typeof v=="function")P=function(){v(x)};else if(typeof MessageChannel<"u"){var Ft=new MessageChannel,Jn=Ft.port2;Ft.port1.onmessage=x,P=function(){Jn.postMessage(null)}}else P=function(){k(x,0)};function Ci(H){E=H,M||(M=!0,P())}function yn(H,ee){w=k(function(){H(t.unstable_now())},ee)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(H){H.callback=null},t.unstable_continueExecution=function(){T||g||(T=!0,Ci(V))},t.unstable_forceFrameRate=function(H){0>H||125<H?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<H?Math.floor(1e3/H):5},t.unstable_getCurrentPriorityLevel=function(){return m},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(H){switch(m){case 1:case 2:case 3:var ee=3;break;default:ee=m}var K=m;m=ee;try{return H()}finally{m=K}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(H,ee){switch(H){case 1:case 2:case 3:case 4:case 5:break;default:H=3}var K=m;m=H;try{return ee()}finally{m=K}},t.unstable_scheduleCallback=function(H,ee,K){var te=t.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?te+K:te):K=te,H){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=K+re,H={id:h++,callback:ee,priorityLevel:H,startTime:K,expirationTime:re,sortIndex:-1},K>te?(H.sortIndex=K,e(c,H),n(l)===null&&H===n(c)&&(S?(I(w),w=-1):S=!0,yn(C,K-te))):(H.sortIndex=re,e(l,H),T||g||(T=!0,Ci(V))),H},t.unstable_shouldYield=b,t.unstable_wrapCallback=function(H){var ee=m;return function(){var K=m;m=ee;try{return H.apply(this,arguments)}finally{m=K}}}})(JE);YE.exports=JE;var Mk=YE.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _u{constructor(e,n,r,i,s){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const i=new Map;return i.set(e,yu.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new _u(Z.min(),i,new ve(ne),Wt(),ie())}}class yu{constructor(e,n,r,i,s){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new yu(r,n,ie(),ie(),ie())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sd{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new U(O.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new U(O.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return ne(this._lat,e._lat)||ne(this._long,e._long)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Et{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=Et.makeFromUrl(e,n)}catch{return new Et(e,"")}if(r.path==="")return r;throw IM(e)}static makeFromUrl(e,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function s(C){C.path.charAt(C.path.length-1)==="/"&&(C.path_=C.path_.slice(0,-1))}const o="(/(.*))?$",a=new RegExp("^gs://"+i+o,"i"),l={bucket:1,path:3};function c(C){C.path_=decodeURIComponent(C.path)}const h="v[A-Za-z0-9_]+",f=n.replace(/[.]/g,"\\."),m="(/([^?#]*).*)?$",g=new RegExp(`^https?://${f}/${h}/b/${i}/o${m}`,"i"),T={bucket:1,path:3},S=n===tP?"(?:storage.googleapis.com|storage.cloud.google.com)":n,k="([^?#]*)",I=new RegExp(`^https?://${S}/${i}/${k}`,"i"),y=[{regex:a,indices:l,postModify:s},{regex:g,indices:T,postModify:c},{regex:I,indices:{bucket:1,path:2},postModify:c}];for(let C=0;C<y.length;C++){const V=y[C],M=V.regex.exec(e);if(M){const E=M[V.indices.bucket];let w=M[V.indices.path];w||(w=""),r=new Et(E,w),V.postModify(r);break}}if(r==null)throw wM(e);return r}}class AM{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PM(t,e,n){let r=1,i=null,s=null,o=!1,a=0;function l(){return a===2}let c=!1;function h(...k){c||(c=!0,e.apply(null,k))}function f(k){i=setTimeout(()=>{i=null,t(g,l())},k)}function m(){s&&clearTimeout(s)}function g(k,...I){if(c){m();return}if(k){m(),h.call(null,k,...I);return}if(l()||o){m(),h.call(null,k,...I);return}r<64&&(r*=2);let y;a===1?(a=2,y=0):y=(r+Math.random())*1e3,f(y)}let T=!1;function S(k){T||(T=!0,m(),!c&&(i!==null?(k||(a=2),clearTimeout(i),f(0)):k||(a=1)))}return f(0),s=setTimeout(()=>{o=!0,S(!0)},n),S}function kM(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,m=`\r
--`+l+"--",g=Vn.getBlob(f,r,m);if(g===null)throw sP();const T={name:c.fullPath},S=Pi(s,t.host,t._protocol),k="POST",I=t.maxUploadRetryTime,v=new kr(S,k,Od(t,n),I);return v.urlParams=T,v.headers=o,v.body=g.uploadData(),v.errorHandler=ua(e),v}class Fh{constructor(e,n,r,i){this.current=e,this.total=n,this.finalized=!!r,this.metadata=i||null}}function X_(t,e){let n=null;try{n=t.getResponseHeader("X-Goog-Upload-Status")}catch{Hn(!1)}return Hn(!!n&&(e||["active"]).indexOf(n)!==-1),n}function lF(t,e,n,r,i){const s=e.bucketOnlyServerUrl(),o=_P(e,r,i),a={name:o.fullPath},l=Pi(s,t.host,t._protocol),c="POST",h={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},f=J_(o,n),m=t.maxUploadRetryTime;function g(S){X_(S);let k;try{k=S.getResponseHeader("X-Goog-Upload-URL")}catch{Hn(!1)}return Hn(Dd(k)),k}const T=new kr(l,c,g,m);return T.urlParams=a,T.headers=h,T.body=f,T.errorHandler=ua(e),T}function uF(t,e,n,r){const i={"X-Goog-Upload-Command":"query"};function s(c){const h=X_(c,["active","final"]);let f=null;try{f=c.getResponseHeader("X-Goog-Upload-Size-Received")}catch{Hn(!1)}f||Hn(!1);const m=Number(f);return Hn(!isNaN(m)),new Fh(m,r.size(),h==="final")}const o="POST",a=t.maxUploadRetryTime,l=new kr(n,o,s,a);return l.headers=i,l.errorHandler=ua(e),l}const sE=256*1024;function cF(t,e,n,r,i,s,o,a){const l=new Fh(0,0);if(o?(l.current=o.current,l.total=o.total):(l.current=0,l.total=r.size()),r.size()!==l.total)throw TM();const c=l.total-l.current;let h=c;i>0&&(h=Math.min(h,i));const f=l.current,m=f+h;let g="";h===0?g="finalize":c===h?g="upload, finalize":g="upload";const T={"X-Goog-Upload-Command":g,"X-Goog-Upload-Offset":`${l.current}`},S=r.slice(f,m);if(S===null)throw sP();function k(C,V){const M=X_(C,["active","final"]),E=l.current+h,w=r.size();let R;return M==="final"?R=Od(e,s)(C,V):R=null,new Fh(E,w,M==="final",R)}const I="POST",v=e.maxUploadRetryTime,y=new kr(n,I,k,v);return y.headers=T,y.body=S.uploadData(),y.progressCallback=a||null,y.errorHandler=ua(t),y}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hj="storage-compat";function dj(t,{instanceIdentifier:e}){const n=t.getProvider("app-compat").getImmediate(),r=t.getProvider("storage").getImmediate({identifier:e});return new O1(n,r)}function fj(t){const e={TaskState:bt,TaskEvent:hF,StringFormat:cn,Storage:O1,Reference:pr};t.INTERNAL.registerComponent(new gn(hj,dj,"PUBLIC").setServiceProps(e).setMultipleInstances(!0)),t.registerVersion(uj,cj)}fj(bs);const Ty=bs.initializeApp({apiKey:"AIzaSyBHgG4mwWSEUBLPS1p2XFtaC8GwPIv2xN8",authDomain:"arquidiocesishermosillo-776dd.firebaseapp.com",projectId:"arquidiocesishermosillo-776dd",storageBucket:"arquidiocesishermosillo-776dd.appspot.com",messagingSenderId:"767127814821",appId:"1:767127814821:web:6c159d62075bcd1271c34c"}),Km=c4(Ty),up=PL(Ty),pj=OF(Ty);var V1={exports:{}};(()=>{var t={d:(s,o)=>{for(var a in o)t.o(o,a)&&!t.o(s,a)&&Object.defineProperty(s,a,{enumerable:!0,get:o[a]})},o:(s,o)=>Object.prototype.hasOwnProperty.call(s,o),r:s=>{typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(s,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(s,"__esModule",{value:!0})}},e={};function n(s,o){for(var a=0;a<o.length;a++){var l=o[a];l.enumerable=l.enumerable||!1,l.configurable=!0,"value"in l&&(l.writable=!0),Object.defineProperty(s,l.key,l)}}t.r(e),t.d(e,{default:()=>i});var r=function(){function s(){(function(l,c){if(!(l instanceof c))throw new TypeError("Cannot call a class as a function")})(this,s)}var o,a;return o=s,a=[{key:"changeHeightWidth",value:function(l,c,h,f,m,g){return h>f&&(l=Math.round(l*f/h),h=f),l>c&&(h=Math.round(h*c/l),l=c),m&&h<m&&(l=Math.round(l*m/h),h=m),g&&l<g&&(h=Math.round(h*g/l),l=g),{height:l,width:h}}},{key:"resizeAndRotateImage",value:function(l,c,h,f,m){var g=arguments.length>5&&arguments[5]!==void 0?arguments[5]:"jpeg",T=arguments.length>6&&arguments[6]!==void 0?arguments[6]:100,S=arguments.length>7&&arguments[7]!==void 0?arguments[7]:0,k=T/100,I=document.createElement("canvas"),v=l.width,y=l.height,C=this.changeHeightWidth(y,h,v,c,f,m);!S||S!==90&&S!==270?(I.width=C.width,I.height=C.height):(I.width=C.height,I.height=C.width),v=C.width,y=C.height;var V=I.getContext("2d");return V.fillStyle="rgba(0, 0, 0, 0)",V.fillRect(0,0,v,y),V.imageSmoothingEnabled&&V.imageSmoothingQuality&&(V.imageSmoothingQuality="high"),S&&(V.rotate(S*Math.PI/180),S===90?V.translate(0,-I.width):S===180?V.translate(-I.width,-I.height):S===270?V.translate(-I.height,0):S!==0&&S!==360||V.translate(0,0)),V.drawImage(l,0,0,v,y),I.toDataURL("image/".concat(g),k)}},{key:"b64toByteArrays",value:function(l,c){for(var h=atob(l.toString().replace(/^data:image\/(png|jpeg|jpg|webp);base64,/,"")),f=[],m=0;m<h.length;m+=512){for(var g=h.slice(m,m+512),T=new Array(g.length),S=0;S<g.length;S++)T[S]=g.charCodeAt(S);var k=new Uint8Array(T);f.push(k)}return f}},{key:"b64toBlob",value:function(l,c){var h=this.b64toByteArrays(l,c);return new Blob(h,{type:c,lastModified:new Date})}},{key:"b64toFile",value:function(l,c,h){var f=this.b64toByteArrays(l,h);return new File(f,c,{type:h,lastModified:new Date})}},{key:"createResizedImage",value:function(l,c,h,f,m,g,T){var S=arguments.length>7&&arguments[7]!==void 0?arguments[7]:"base64",k=arguments.length>8&&arguments[8]!==void 0?arguments[8]:null,I=arguments.length>9&&arguments[9]!==void 0?arguments[9]:null,v=new FileReader;if(!l)throw Error("File Not Found!");if(l.type&&!l.type.includes("image"))throw Error("File Is NOT Image!");v.readAsDataURL(l),v.onload=function(){var y=new Image;y.src=v.result,y.onload=function(){var C=s.resizeAndRotateImage(y,c,h,k,I,f,m,g),V="image/".concat(f);switch(S){case"blob":var M=s.b64toBlob(C,V);T(M);break;case"base64":T(C);break;case"file":var E=l.name.toString().replace(/(png|jpeg|jpg|webp)$/i,"").concat(f.toString()),w=s.b64toFile(C,E,V);T(w);break;default:T(C)}}},v.onerror=function(y){throw Error(y)}}}],a&&n(o,a),s}();const i={imageFileResizer:function(s,o,a,l,c,h,f,m,g,T){return r.createResizedImage(s,o,a,l,c,h,f,m,g,T)}};V1.exports=e})();var mj=V1.exports;const gj=ME(mj);var _j={exports:{}};(function(t,e){(function(n,r){r()})(ka,function(){function n(c,h){return typeof h>"u"?h={autoBom:!1}:typeof h!="object"&&(console.warn("Deprecated: Expected third argument to be a object"),h={autoBom:!h}),h.autoBom&&/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(c.type)?new Blob(["\uFEFF",c],{type:c.type}):c}function r(c,h,f){var m=new XMLHttpRequest;m.open("GET",c),m.responseType="blob",m.onload=function(){l(m.response,h,f)},m.onerror=function(){console.error("could not download file")},m.send()}function i(c){var h=new XMLHttpRequest;h.open("HEAD",c,!1);try{h.send()}catch{}return 200<=h.status&&299>=h.status}function s(c){try{c.dispatchEvent(new MouseEvent("click"))}catch{var h=document.createEvent("MouseEvents");h.initMouseEvent("click",!0,!0,window,0,0,0,80,20,!1,!1,!1,!1,0,null),c.dispatchEvent(h)}}var o=typeof window=="object"&&window.window===window?window:typeof self=="object"&&self.self===self?self:typeof ka=="object"&&ka.global===ka?ka:void 0,a=o.navigator&&/Macintosh/.test(navigator.userAgent)&&/AppleWebKit/.test(navigator.userAgent)&&!/Safari/.test(navigator.userAgent),l=o.saveAs||(typeof window!="object"||window!==o?function(){}:"download"in HTMLAnchorElement.prototype&&!a?function(c,h,f){var m=o.URL||o.webkitURL,g=document.createElement("a");h=h||c.name||"download",g.download=h,g.rel="noopener",typeof c=="string"?(g.href=c,g.origin===location.origin?s(g):i(g.href)?r(c,h,f):s(g,g.target="_blank")):(g.href=m.createObjectURL(c),setTimeout(function(){m.revokeObjectURL(g.href)},4e4),setTimeout(function(){s(g)},0))}:"msSaveOrOpenBlob"in navigator?function(c,h,f){if(h=h||c.name||"download",typeof c!="string")navigator.msSaveOrOpenBlob(n(c,f),h);else if(i(c))r(c,h,f);else{var m=document.createElement("a");m.href=c,m.target="_blank",setTimeout(function(){s(m)})}}:function(c,h,f,m){if(m=m||open("","_blank"),m&&(m.document.title=m.document.body.innerText="downloading..."),typeof c=="string")return r(c,h,f);var g=c.type==="application/octet-stream",T=/constructor/i.test(o.HTMLElement)||o.safari,S=/CriOS\/[\d]+/.test(navigator.userAgent);if((S||g&&T||a)&&typeof FileReader<"u"){var k=new FileReader;k.onloadend=function(){var y=k.result;y=S?y:y.replace(/^data:[^;]*;/,"data:attachment/file;"),m?m.location.href=y:location=y,m=null},k.readAsDataURL(c)}else{var I=o.URL||o.webkitURL,v=I.createObjectURL(c);m?m.location=v:location.href=v,m=null,setTimeout(function(){I.revokeObjectURL(v)},4e4)}});o.saveAs=l.saveAs=l,t.exports=l})})(_j);function yj({finderCollection:t,postFile:e,arrParroquiaState:n,setGetArr:r,getArr:i,finderFireBase:s}){const[o,a]=j.useState({nombre:"",fecha:""}),{nombre:l,fecha:c}=o,h=({target:K})=>{C(!0),M(!0);const{name:te,value:re}=K;a({...o,[te]:re.replace(/\b[a-z]/g,se=>se.toUpperCase())})},[f,m]=j.useState(void 0),g=window.indexedDB||window.mozIndexedDB||window.webkitIndexedDB||window.msIndexedDB||window.shimIndexedDB,T=()=>{if(!g){alert("Use el Navegador Google");return}const K=g.open(t);K.onerror=function(te){console.error("An error occurred with IndexedDB"),console.error(te)},K.onupgradeneeded=function(te){const re=K.result;re.objectStoreNames.contains("userData")||re.createObjectStore("userData",{keyPath:"id"}).createIndex("nombreBuscar","nombre",{unique:!1}),console.log("Bautismos.jsx-onupgradeneeded",te)},K.onsuccess=function(){let re=K.result.transaction("userData","readwrite"),se=re.objectStore("userData");return f!==void 0&&(se.add({id:Date.now(),nombre:l,fecha:c,img64:f}),localStorage.setItem("64",f),m(void 0)),re.complete}};j.useEffect(()=>{a({nombre:"",fecha:""}),I("")},[t]);const S=K=>new Promise(te=>{gj.imageFileResizer(K,612,791,"JPEG",80,0,re=>{te(re),m(re)},"base64")}).catch(te=>{console.log(te),console.log("SE MAMARON!!"),alert("El Archivo Cargado No es una Imagen")}),[k,I]=j.useState();console.log(k);const v=async K=>{w(!0);const te=K.target.files[0],re=await S(te);fetch(re).then(se=>se.blob()).then(se=>{const vn=new File([se],K.target.files[0].name.split(".")[0]+".jpeg",{type:"image/jpeg"});I(vn)}).catch(se=>{console.log(se),console.log("SE MAMARON onResize!!")});try{let se=!!new Blob}catch(se){alert(se),console.log(se)}},[y,C]=j.useState(!0),[V,M]=j.useState(!0),[E,w]=j.useState(!0),R=()=>{if(l.length<=0){C("El Nombre esta Vacio");return}if(c.length<=0){M("La Fecha esta Vacia");return}if(k===""){w("No Hay Archivo Seleccionado");return}T(),confirm(`Quiere Guardar este Documento de ${t}?`)&&(o.email=localStorage.userEmailLS,o.nombre=l.trim(),e(k,o),setTimeout(()=>{alert("Documento Guardado")},2e3)),a({nombre:"",fecha:""}),I("")},[A,b]=j.useState(!0),[x,P]=j.useState(""),Ft=()=>{if(x.length<=0){b("Campo de Busqueda Vacio  ✘ ");return}s(x),r(!i),setTimeout(()=>{b(!1)},300),n.length>=1?b(!1):b("Buscando...")},Jn=({target:K})=>{const{name:te,value:re}=K;P(re.replace(/\b[a-z]/g,se=>se.toUpperCase()))},Ci=()=>new Date().toLocaleString().slice(3,9),yn=()=>{const K=`data:text/txt;chatset=utf-8,${encodeURIComponent(JSON.stringify(allUsers))}`,te=document.createElement("a");te.href=K,te.download=`${Ci()}-${t}-Respaldo.txt`,te.click()},[H,ee]=j.useState(!0);return F.jsx(F.Fragment,{children:localStorage.getItem("userEmailLS")!==null&&F.jsxs(F.Fragment,{children:[F.jsxs("div",{className:"ButtonsNuevoBuscar",children:[F.jsxs("button",{onClick:()=>ee(!0),children:["  Nuevo ",t," "]}),F.jsxs("button",{onClick:()=>ee(!1),children:[" Buscar  "," "]})]}),H?F.jsxs("div",{className:"formInfoToSave",children:[F.jsxs("p",{children:["Respaldar Acta de ",t]}),F.jsx("div",{className:"empty",children:y}),F.jsx("input",{type:"text",name:"nombre",placeholder:"Nombre...",value:l,onChange:K=>h(K)}),F.jsx("div",{className:"empty",children:V}),F.jsx("input",{type:"date",name:"fecha",value:c,onChange:K=>h(K)}),F.jsx("div",{className:"empty",children:E}),F.jsx("input",{className:"fileImg",type:"file",onChange:K=>v(K)}),F.jsx("button",{className:"button-primary",onClick:R,children:"GUARDAR"}),F.jsx("button",{onClick:yn,children:"Guardar Respaldo Mensual"})]}):F.jsxs("div",{className:"formInfoToFind",children:[F.jsxs("div",{children:[F.jsxs("label",{htmlFor:"avatar1",children:["Buscar ",t," con Nombre:"]}),F.jsx("input",{type:"search",id:"avatar1",className:"w-80",value:x,onChange:K=>Jn(K),placeholder:"Nombre Completo..."}),F.jsxs("button",{className:"btn-buscar button-primary",onClick:Ft,children:[" ",F.jsx("span",{className:"lupita",children:"⌕"})]})]}),F.jsx("p",{className:A?"d-none":"cerrar",onClick:()=>b(!A),children:"Cerrar Busqueda ✘"}),F.jsx("p",{className:A?"no-encontrado":"d-none",onClick:()=>b(!0),children:A}),F.jsx("div",{className:A?"d-none":"w-100",children:n.map((K,te)=>F.jsxs("div",{children:[F.jsx("hr",{}),F.jsxs("p",{children:[F.jsx("span",{children:"Nombre:"})," ",K.nombre]}),F.jsxs("p",{children:[F.jsx("span",{children:"Fecha:"})," ",K.fecha]}),F.jsxs("p",{children:[F.jsx("span",{children:"Documento:"})," ",K.fileName]}),F.jsx("a",{className:"doc",href:K.fileUrl,target:"_blanck",children:" Abrir Documento"}),F.jsx("hr",{})]},te))})]})]})})}const vj="https://xipeRafa.github.io/Respalder/assets/abc-EqxUIFmM.jpeg",wj="_loginContainer_1jqwq_1",Ij="_borderB_1jqwq_63",Ej="_borderBgray_1jqwq_71",Tj="_inputBG_1jqwq_81",Sj="_colorRed_1jqwq_103",Rj="_hello_1jqwq_107",Aj="_alabado_1jqwq_117",En={loginContainer:wj,borderB:Ij,borderBgray:Ej,inputBG:Tj,colorRed:Sj,hello:Rj,alabado:Aj},Pj=()=>{const t=async(r,i,s)=>{try{await t1(r,i,s),e(r,i,s),localStorage.setItem("userEmailLS",i)}catch(o){console.error("code.error",o.code),console.log(o.message);const a={"auth/email-already-in-use":()=>alert("El Correo ya esta en Uso."),"auth/operation-not-allowed":()=>alert("Operacion No Permitida."),"auth/weak-password":()=>alert("La Contraseña es muy débil."),"auth/invalid-email":()=>alert("El Correo No es Valido.")};(c=>{a[c]()})(o.code),location.reload()}},e=(r,i,s)=>{n1(r,i,s).then(o=>{const a=o.user;localStorage.setItem("userEmailLS",a.email),location.reload()}).catch(o=>{console.log(o.code),console.log(o.message);const a={"auth/operation-not-allowed":()=>alert("Operacion No Permitida."),"auth/invalid-credential":()=>alert("Contraseña o Correo son Incorrrectos."),"auth/invalid-email":()=>alert("El Correo No es Valido")};(c=>{a[c]()})(o.code),location.reload()})};return[t,e,()=>{PU(Km),localStorage.removeItem("userEmailLS"),localStorage.removeItem("userName"),location.reload()}]};function kj({saveCat:t}){const[e,n,r]=Pj(),[i,s]=j.useState(""),[o,a]=j.useState({name:"",email:"",password:"",password2:""}),{name:l,email:c,password:h,password2:f}=o,m=I=>{s("");const{name:v,value:y}=I.target;a({...o,[v]:y})},g=()=>{if(s(""),l.length<1){s("Nombre No Escrito");return}if(c.length<1){s("Correo No Escrito");return}if(h!==f){s("Passwords No son Iguales");return}if(h.length<6){s("La Clave es muy Corta Use 6 Caracteres Minimo");return}e(Km,c,h),t(o),localStorage.setItem("userName",l)},T=()=>{if(s(""),c.length<1){s("Correo No Escrito");return}if(h.length<6){s("Claves es muy corta Use 6 caracteres Minimo");return}n(Km,c,h)},[S,k]=j.useState(!0);return F.jsx(F.Fragment,{children:localStorage.getItem("userEmailLS")===null?F.jsxs("div",{className:En.loginContainer,children:[F.jsx("div",{children:F.jsx("img",{src:vj})}),F.jsxs("div",{children:[F.jsxs("div",{children:[F.jsx("div",{className:S?En.borderB:En.borderBgray,onClick:()=>{k(!0),s(""),a({name:"",email:"",password:"",password2:""})},children:"REGISTRO"}),F.jsx("div",{className:S?En.borderBgray:En.borderB,onClick:()=>{k(!1),s(""),a({name:"",email:"",password:"",password2:""})},children:"ENTRAR"})]}),F.jsx("div",{children:S?F.jsxs("div",{className:En.inputBG,children:[F.jsx("div",{children:F.jsx("input",{type:"text",name:"name",value:l,onChange:I=>m(I),placeholder:"Nombre"})}),F.jsx("div",{children:F.jsx("input",{type:"email",name:"email",value:c,onChange:I=>m(I),placeholder:"Correo"})}),F.jsx("div",{children:F.jsx("input",{type:"password",name:"password",value:h,onChange:I=>m(I),placeholder:"Password"})}),F.jsx("div",{children:F.jsx("input",{type:"password",name:"password2",value:f,onChange:I=>m(I),placeholder:"Confirmar Password"})}),F.jsx("div",{children:F.jsx("button",{onClick:()=>g(),children:"ENVIAR"})}),F.jsx("span",{className:En.colorRed,children:i})]}):F.jsxs("div",{className:En.inputBG,children:[F.jsx("div",{children:F.jsx("input",{type:"email",name:"email",value:c,onChange:I=>m(I),placeholder:"Correo"})}),F.jsx("div",{children:F.jsx("input",{type:"password",name:"password",value:h,onChange:I=>m(I),placeholder:"Password"})}),F.jsx("div",{children:F.jsx("button",{onClick:()=>T(),children:"ENTRAR"})}),F.jsx("span",{className:En.colorRed,children:i})]})})]})]}):F.jsxs("div",{children:[F.jsxs("div",{className:En.hello,children:[F.jsx("span",{children:localStorage.userEmailLS.split("@")[0]}),F.jsx("button",{onClick:()=>r(),children:"SALIR"})]}),F.jsx("h1",{className:En.alabado,children:"¡ALABADO SEA JESUCRISTO!"}),F.jsxs("h4",{children:[F.jsx("b",{children:"¡Hola!"})," Bienvenido ",localStorage.userName," Seleccioná una Opción en el Menú"]})]})})}function Cj(){const t=()=>{const T={weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"numeric",minute:"numeric",second:"numeric"};return new Date().toLocaleString("es-ES",T)},[e,n]=j.useState(),[r,i]=j.useState(),[s,o]=j.useState(),[a,l]=j.useState(),[c,h]=j.useState(),f=window.indexedDB||window.mozIndexedDB||window.webkitIndexedDB||window.msIndexedDB||window.shimIndexedDB,m=()=>{const T=f.open("Bautismo");T.onerror=function(y){console.error("An error occurred with IndexedDB"),console.error(y)},T.onupgradeneeded=function(y){const C=T.result;C.objectStoreNames.contains("userData")||C.createObjectStore("userData",{keyPath:"id"}).createIndex("nombreBuscar","nombre",{unique:!1})},T.onsuccess=()=>{const y=T.result;let C=y.transaction("userData","readonly");const M=C.objectStore("userData").getAll();M.onsuccess=E=>{E.srcElement.result.length!==0&&n(E.srcElement.result)},C.oncomplete=function(){y.close()}};const S=f.open("Comunion");S.onerror=function(y){console.error("An error occurred with IndexedDB"),console.error(y)},S.onupgradeneeded=function(y){const C=S.result;C.objectStoreNames.contains("userData")||C.createObjectStore("userData",{keyPath:"id"}).createIndex("nombreBuscar","nombre",{unique:!1})},S.onsuccess=()=>{const y=S.result;let C=y.transaction("userData","readonly");const M=C.objectStore("userData").getAll();M.onsuccess=E=>{E.srcElement.result.length!==0&&i(E.srcElement.result)},C.oncomplete=function(){y.close()}};const k=f.open("Confirmacion");k.onerror=function(y){console.error("An error occurred with IndexedDB"),console.error(y)},k.onupgradeneeded=function(y){const C=k.result;C.objectStoreNames.contains("userData")||C.createObjectStore("userData",{keyPath:"id"}).createIndex("nombreBuscar","nombre",{unique:!1})},k.onsuccess=()=>{const y=k.result;let C=y.transaction("userData","readonly");const M=C.objectStore("userData").getAll();M.onsuccess=E=>{E.srcElement.result.length!==0&&o(E.srcElement.result)},C.oncomplete=function(){y.close()}};const I=f.open("Matrimonio");I.onerror=function(y){console.error("An error occurred with IndexedDB"),console.error(y)},I.onupgradeneeded=function(y){const C=I.result;C.objectStoreNames.contains("userData")||C.createObjectStore("userData",{keyPath:"id"}).createIndex("nombreBuscar","nombre",{unique:!1})},I.onsuccess=()=>{const y=I.result;let C=y.transaction("userData","readonly");const M=C.objectStore("userData").getAll();M.onsuccess=E=>{E.srcElement.result.length!==0&&l(E.srcElement.result)},C.oncomplete=function(){y.close()}};const v=f.open("Defuncion");v.onerror=function(y){console.error("An error occurred with IndexedDB"),console.error(y)},v.onupgradeneeded=function(y){const C=v.result;C.objectStoreNames.contains("userData")||C.createObjectStore("userData",{keyPath:"id"}).createIndex("nombreBuscar","nombre",{unique:!1})},v.onsuccess=()=>{const y=v.result;let C=y.transaction("userData","readonly");const M=C.objectStore("userData").getAll();M.onsuccess=E=>{E.srcElement.result.length!==0&&h(E.srcElement.result)},C.oncomplete=function(){y.close()}}},g=()=>{const T=()=>new Date().toLocaleString().slice(0,9),S=`data:text/txt;chatset=utf-8,${encodeURIComponent(JSON.stringify([e,r,s,a,c].flat().filter(I=>I!==void 0)))}`,k=document.createElement("a");k.href=S,k.download=`${T()}-Respaldo.txt`,k.click()};return F.jsxs(F.Fragment,{children:[F.jsx("p",{className:"red",children:t()}),F.jsx("button",{onClick:()=>m(),children:" Guardar Respaldo Mensual "}),F.jsx("button",{className:[e,r,s,a,c].flat().some(T=>T!==void 0)?"ml-2":"d-none",onClick:()=>g(),children:" Descargar "})]})}function bj(){const[t,e]=j.useState(!0),n=window.innerWidth,r=()=>{n<999&&e(!0)},i=()=>{const s={weekday:"long",year:"numeric",month:"long",day:"numeric"};return new Date().toLocaleString("es-ES",s)};return F.jsx("div",{className:"navBar3",children:localStorage.getItem("userEmailLS")!==null&&F.jsxs(F.Fragment,{children:[F.jsxs("div",{onClick:()=>e(!t),className:"hamburger",children:[F.jsxs("div",{className:"menu-bar",children:[F.jsx("div",{className:"uno"}),F.jsx("div",{className:"dos"}),F.jsx("div",{className:"tres"})]}),F.jsx("p",{className:"menuIcons",children:t?F.jsx("b",{className:"menuIcon",children:"MENU"}):F.jsx("b",{className:"menuIconX",children:"✘"})})]}),F.jsxs("div",{className:t?"menu3 ":"menu3 display",onClick:r,children:[F.jsx(Oi,{to:"/Respalder/",className:"no-bg",children:"Mi Parroquia"}),F.jsx(Oi,{to:"/Respalder/bautismos",children:"Bautismos"}),F.jsx(Oi,{to:"/Respalder/comuniones",children:" Comuniones"}),F.jsx(Oi,{to:"/Respalder/confirmaciones",className:"ls",children:" Confirmaciones "}),F.jsx(Oi,{to:"/Respalder/matrimonios",children:" Matrimonios"}),F.jsx(Oi,{to:"/Respalder/defunciones",children:" Defunciones"}),F.jsx(Oi,{to:"/Respalder/Publicidad",className:"red",children:i()})]}),"   "]})})}function xj(){function t(g){let T=g.charAt(0).toUpperCase()+g.slice(1);return g.slice(-2,-1)==="e"?T.slice(0,-2):T.slice(0,-1)}const e=Xo();let n=e.pathname.split("/")[2],r=t(n||"a");const[i,s]=j.useState(""),[o,a]=j.useState([]),[l,c]=j.useState(!1);console.log(o),j.useEffect(()=>{const g=rr(gl(up,n||"bautismos"),Dm("email","==",localStorage.getItem("userEmailLS")),Dm("nombre","==",i.trim()));ZA(g).then(T=>{a(T.docs.map(S=>({...S.data(),id:S.id})))}).catch(T=>{console.error(T)})},[l]);const h=g=>{s(g)},f=(g,T)=>{console.log(g);const S=gl(up,n||"bautismos"),k=Lm(pj,`${n}-Files/${Date.now()}/${g==null?void 0:g.name}`);AF(k,g).then(()=>{RP(k).then(I=>{T.fileName=g.name,T.fileUrl=I,Om(S,T)})}).catch(I=>{console.log("postFile Error, App,jsx"),console.log(I)})},m=g=>{delete g.password,delete g.name;const T=gl(up,"cat");Om(T,g).then(S=>{console.log(S)}).catch(S=>{console.log("saveCat Error, App.jsx"),console.log(S)})};return F.jsxs("div",{className:localStorage.getItem("userEmailLS")!==null?"containerApp":"containerApp2",children:[F.jsx(bj,{}),e.pathname=="/Respalder/"&&localStorage.getItem("userEmailLS")!==null?"":F.jsx("h3",{className:localStorage.getItem("userEmailLS")!==null?"registroParroquial-h3":"registroParroquial-h3-2",children:"RESPALDER PARROQUIAL"}),F.jsxs(Cx,{children:[F.jsx(Oc,{path:"/Respalder/",element:F.jsx(kj,{saveCat:m})}),F.jsx(Oc,{path:"/Respalder/publicidad",element:F.jsx(Cj,{})}),F.jsx(Oc,{path:"*",element:e.pathname!=="/Respalder/"&&localStorage.getItem("userEmailLS")!==null&&F.jsx(yj,{finderCollection:r,finderFireBase:h,postFile:f,arrParroquiaState:o,setGetArr:c,getArr:l})})]})]})}cp.createRoot(document.getElementById("root")).render(F.jsx(Mx,{children:F.jsx(xj,{})}));
